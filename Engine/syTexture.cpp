...
namespace sy::graphics
{
	...
	void Texture::BindShader(ShaderStage stage, UINT slot)
	{
	...
	void Texture::Clear()
	{
		...
		GetDevice()->SetShaderResource(ShaderStage::VS, 0, &srv);
		GetDevice()->SetShaderResource(ShaderStage::DS, 0, &srv);
		GetDevice()->SetShaderResource(ShaderStage::GS, 0, &srv);
		GetDevice()->SetShaderResource(ShaderStage::HS, 0, &srv);
		GetDevice()->SetShaderResource(ShaderStage::CS, 0, &srv);
		GetDevice()->SetShaderResource(ShaderStage::PS, 0, &srv);
	}
}
